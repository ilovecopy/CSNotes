  ...
  theme: defaultTheme({
    ...
    sidebar: {
      '/java/': [
        ...
        {
          text: '第三章 设计模式',
          children: ['/java/0301.md', '/java/0302.md', '/java/0303.md', '/java/0304.md'],
        },
      ...
      '/computerOrganization/': [
        {
          text: '第一章 计算机系统概述',
          children: ['/computerOrganization/0101.md', '/computerOrganization/0102.md'],
        },
        {
          text: '第二章 数据的表示和运算',
          children: [
            '/computerOrganization/0201.md',
            '/computerOrganization/0202.md',
            '/computerOrganization/0203.md',
          ],
        },
        {
          text: '第三章 存储系统',
          children: [
            '/computerOrganization/0301.md',
            '/computerOrganization/0302.md',
            '/computerOrganization/0303.md',
            '/computerOrganization/0304.md',
            '/computerOrganization/0305.md',
            '/computerOrganization/0306.md',
          ],
        },
        {
          text: '第四章 指令系统',
          children: [
            '/computerOrganization/0401.md',
            '/computerOrganization/0402.md',
            '/computerOrganization/0403.md',
            '/computerOrganization/0404.md',
          ],
        },
        {
          text: '第五章 中央处理器',
          children: [
            '/computerOrganization/0501.md',
            '/computerOrganization/0502.md',
            '/computerOrganization/0503.md',
            '/computerOrganization/0504.md',
            '/computerOrganization/0505.md',
            '/computerOrganization/0506.md',
            '/computerOrganization/0507.md',
          ],
        },
        {
          text: '第六章 总线',
          children: ['/computerOrganization/0601.md', '/computerOrganization/0602.md'],
        },
        {
          text: '第七章 输入/输出系统',
          children: [
            '/computerOrganization/0701.md',
            '/computerOrganization/0702.md',
            '/computerOrganization/0703.md',
          ],
        },
      ...
      '/datastructure/': [
        ...
        {
          text: '第二章 线性表',
          children: ['/datastructure/0201.md', '/datastructure/0202.md', '/datastructure/0203.md'],
        },
        {
          text: '第三章 栈、队列和数组',
          children: [
            '/datastructure/0301.md',
            '/datastructure/0302.md',
            '/datastructure/0303.md',
            '/datastructure/0304.md',
          ],
        },
        { text: '第四章 串', children: ['/datastructure/0401.md', '/datastructure/0402.md'] },
        {
          text: '第五章 树与二叉树',
          children: [
            '/datastructure/0501.md',
            '/datastructure/0502.md',
            '/datastructure/0503.md',
            '/datastructure/0504.md',
            '/datastructure/0505.md',
          ],
        },
        {
          text: '第六章 图',
          children: [
            '/datastructure/0601.md',
            '/datastructure/0602.md',
            '/datastructure/0603.md',
            '/datastructure/0604.md',
          ],
        },
        {
          text: '第七章 查找',
          children: [
            '/datastructure/0701.md',
            '/datastructure/0702.md',
            '/datastructure/0703.md',
            '/datastructure/0704.md',
            '/datastructure/0705.md',
          ],
        },
        {
          text: '第八章 排序',
          children: [
            '/datastructure/0801.md',
            '/datastructure/0802.md',
            '/datastructure/0803.md',
            '/datastructure/0804.md',
            '/datastructure/0805.md',
            '/datastructure/0806.md',
          ],
        },
      ...
      '/os/': [
        {
          text: '第一章 计算机系统概述',
          children: ['/os/0101.md', '/os/0102.md', '/os/0103.md', '/os/0104.md', '/os/0105.md'],
        },
        {
          text: '第二章 进程与线程',
          children: ['/os/0201.md', '/os/0202.md', '/os/0203.md', '/os/0204.md'],
        },
        { text: '第三章 内存管理', children: ['/os/0301.md', '/os/0302.md'] },
        { text: '第四章 文件管理', children: ['/os/0401.md', '/os/0402.md', '/os/0403.md'] },
        {
          text: '第五章 输入/输出（I/O）管理',
          children: ['/os/0501.md', '/os/0502.md', '/os/0503.md'],
        },
      ...
      '/network/': [
        ...
        {
          text: '第二章 物理层',
          children: ['/network/0201.md', '/network/0202.md', '/network/0203.md'],
        },
        {
          text: '第三章 数据链路层',
          children: [
      ...
      '/leetcode/': [
        ...
        {
          text: '第二章 数组与字符串',
          children: ['/leetcode/0106.md', '/leetcode/0107.md', '/leetcode/0108.md'],
        },
      ],
      '/studypath/': [
        {
        ...
        {
          text: '第六章 收藏网站',
          children: ['/studypath/0601.md', '/studypath/0602.md', '/studypath/0603.md'],
        },
      ],
      '/yearplan/': [
