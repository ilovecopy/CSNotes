import{_ as n,c as s,o as a,b as i}from"./app-BKL5x2Aa.js";const e={},l=i(`<h1 id="_1-11-单例模式-饿汉式" tabindex="-1"><a class="header-anchor" href="#_1-11-单例模式-饿汉式"><span>1.11 单例模式 - 饿汉式</span></a></h1><p>类加载时创建。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">public class SingleTon01 {</span>
