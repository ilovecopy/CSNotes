import{_ as s,c as n,b as e,o as i}from"./app-CbCHZGY0.js";const t={};function l(c,a){return i(),n("div",null,a[0]||(a[0]=[e(`<h1 id="_6-1-接口" tabindex="-1"><a class="header-anchor" href="#_6-1-接口"><span>6.1 接口</span></a></h1><p>所谓接口，就是将一些没有实现的方法封装到一起，到某个类要使用的时候，在根据具体情况把这些方法写出来。</p><p>接口中所有方法都自动是 public 的。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">public interface Person {</span>
