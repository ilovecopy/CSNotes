import{_ as s,c as n,o as a,b as e}from"./app-CehCU-_V.js";const l={},i=e(`<h1 id="_3-1-栈" tabindex="-1"><a class="header-anchor" href="#_3-1-栈"><span>3.1 栈</span></a></h1><h2 id="_3-1-1-栈的基本概念" tabindex="-1"><a class="header-anchor" href="#_3-1-1-栈的基本概念"><span>3.1.1 栈的基本概念</span></a></h2><p>只允许在一端进行插入或删除操作的线性表。</p><h2 id="_3-1-2-栈的顺序存储结构" tabindex="-1"><a class="header-anchor" href="#_3-1-2-栈的顺序存储结构"><span>3.1.2 栈的顺序存储结构</span></a></h2><div class="language-c++ line-numbers-mode" data-highlighter="prismjs" data-ext="c++" data-title="c++"><pre class="language-c++"><code><span class="line">typedef struct{</span>
