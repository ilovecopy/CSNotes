import{_ as a,c as e,b as n,o as t}from"./app-CUjDbcK9.js";const i={};function l(r,s){return t(),e("div",null,s[0]||(s[0]=[n(`<h1 id="_10-1-动态规划" tabindex="-1"><a class="header-anchor" href="#_10-1-动态规划"><span>10.1 动态规划</span></a></h1><h2 id="_53-最大子数组和" tabindex="-1"><a class="header-anchor" href="#_53-最大子数组和"><span>53.最大子数组和</span></a></h2><p>给你一个整数数组 <code>nums</code> ，请你找出一个具有最大和的连续子数组（子数组最少包含一个元素），返回其最大和。</p><p><strong>子数组</strong> 是数组中的一个连续部分。</p><p><strong>示例 1：</strong></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">输入：nums = [-2,1,-3,4,-1,2,1,-5,4]</span>
