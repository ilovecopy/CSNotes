import{_ as n,c as a,b as e,o as l}from"./app-CbCHZGY0.js";const i={};function p(t,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="_9-1-贪心算法" tabindex="-1"><a class="header-anchor" href="#_9-1-贪心算法"><span>9.1 贪心算法</span></a></h1><h2 id="_455-分发饼干" tabindex="-1"><a class="header-anchor" href="#_455-分发饼干"><span>455.分发饼干</span></a></h2><p>假设你是一位很棒的家长，想要给你的孩子们一些小饼干。但是，每个孩子最多只能给一块饼干。</p><p>对每个孩子 <code>i</code>，都有一个胃口值 <code>g[i]</code>，这是能让孩子们满足胃口的饼干的最小尺寸；并且每块饼干 <code>j</code>，都有一个尺寸 <code>s[j]</code> 。如果 <code>s[j] &gt;= g[i]</code>，我们可以将这个饼干 <code>j</code> 分配给孩子 <code>i</code> ，这个孩子会得到满足。你的目标是尽可能满足越多数量的孩子，并输出这个最大数值。</p><p><strong>示例 1:</strong></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">输入: g = [1,2,3], s = [1,1]</span>
