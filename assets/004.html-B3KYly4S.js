...
<span class="line">    }</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用 get 和 set 方法会比用下标返回多一个范围检查。</p><p>创建 ArrayList 对象时，如果使用无参构造器，则初始 elementData 容量为 0，第一次添加，则扩容 elementData 为 10。如需要再次扩容，则扩容 elementData 为 1.5 倍。</p><p>集合只能存储引用类型。</p><figure><img src="https://csnotes.oss-cn-beijing.aliyuncs.com/photos/ArrayList扩容.drawio.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>`,9),l=[t];function d(r,c){return s(),n("div",null,l)}const u=e(i,[["render",d],["__file","004.html.vue"]]),m=JSON.parse('{"path":"/java/004.html","title":"1.4 ArrayList 源码解析","lang":"zh-CN","frontmatter":{},"headers":[],"git":{"updatedTime":1720103859000},"filePathRelative":"java/004.md"}');export{u as comp,m as data};
