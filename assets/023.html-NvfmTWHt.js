import{_ as a,c as n,b as e,o as l}from"./app-CUjDbcK9.js";const i={};function p(t,s){return l(),n("div",null,s[0]||(s[0]=[e(`<h1 id="_2-3-线性表的链式表示" tabindex="-1"><a class="header-anchor" href="#_2-3-线性表的链式表示"><span>2.3 线性表的链式表示</span></a></h1><h2 id="_2-3-1-单链表的定义" tabindex="-1"><a class="header-anchor" href="#_2-3-1-单链表的定义"><span>2.3.1 单链表的定义</span></a></h2><h2 id="_2-3-3-双向链表" tabindex="-1"><a class="header-anchor" href="#_2-3-3-双向链表"><span>2.3.3 双向链表</span></a></h2><figure><img src="https://csnotes.oss-cn-beijing.aliyuncs.com/photos/双链表.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-c++ line-numbers-mode" data-highlighter="prismjs" data-ext="c++"><pre><code class="language-c++"><span class="line">#include&lt;iostream&gt;</span>
