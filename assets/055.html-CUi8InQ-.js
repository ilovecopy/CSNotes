import{_ as n,c as s,o as e,a}from"./app-DqI145xI.js";const i={},l=a(`<h1 id="_5-5-树和二叉树的应用" tabindex="-1"><a class="header-anchor" href="#_5-5-树和二叉树的应用"><span>5.5 树和二叉树的应用</span></a></h1><h2 id="_5-5-1-哈夫曼树和哈夫曼编码" tabindex="-1"><a class="header-anchor" href="#_5-5-1-哈夫曼树和哈夫曼编码"><span>5.5.1 哈夫曼树和哈夫曼编码</span></a></h2><p>前缀编码：一条路径上只有一种编码。</p><p>哈夫曼树只有度为 0 和 n 的结点，是严格 n 叉树，可以补充 0 结点。</p><h2 id="_5-5-2-并查集" tabindex="-1"><a class="header-anchor" href="#_5-5-2-并查集"><span>5.5.2 并查集</span></a></h2><p>每个子集合是一棵树，并查集是一个森林。</p><p>双亲表示法能方便并和查</p><p>并：时间复杂度 O(1)</p><p>小并大</p><p>查：时间复杂度 O(n)</p><p>并查集结构定义：并查集本质上是一个双亲指针数组。</p><div class="language-c++ line-numbers-mode" data-highlighter="prismjs" data-ext="c++" data-title="c++"><pre class="language-c++"><code><span class="line">int UFSets[10]; // 双亲指针数组</span>
