import{_ as n,c as s,b as e,o as l}from"./app-CbCHZGY0.js";const t={};function p(i,a){return l(),s("div",null,a[0]||(a[0]=[e(`<h1 id="_8-2-插入排序" tabindex="-1"><a class="header-anchor" href="#_8-2-插入排序"><span>8.2 插入排序</span></a></h1><h2 id="_8-2-1-直接插入排序" tabindex="-1"><a class="header-anchor" href="#_8-2-1-直接插入排序"><span>8.2.1 直接插入排序</span></a></h2><p>空间复杂度$O(1)$</p><p>时间复杂度$O(n^2)$</p><p>稳定。</p><h2 id="leetcode147-对链表进行插入排序" tabindex="-1"><a class="header-anchor" href="#leetcode147-对链表进行插入排序"><span>LeetCode147. 对链表进行插入排序</span></a></h2><div class="language-c++ line-numbers-mode" data-highlighter="prismjs" data-ext="c++"><pre><code class="language-c++"><span class="line"> ListNode *insertionSortList(ListNode *head)</span>
