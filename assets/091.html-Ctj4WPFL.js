import{_ as n,c as s,o as e,b as a}from"./app-BKL5x2Aa.js";const i={},l=a(`<h1 id="_9-1-贪心算法" tabindex="-1"><a class="header-anchor" href="#_9-1-贪心算法"><span>9.1 贪心算法</span></a></h1><h2 id="_455-分发饼干" tabindex="-1"><a class="header-anchor" href="#_455-分发饼干"><span>455.分发饼干</span></a></h2><p>假设你是一位很棒的家长，想要给你的孩子们一些小饼干。但是，每个孩子最多只能给一块饼干。</p><p>对每个孩子 <code>i</code>，都有一个胃口值 <code>g[i]</code>，这是能让孩子们满足胃口的饼干的最小尺寸；并且每块饼干 <code>j</code>，都有一个尺寸 <code>s[j]</code> 。如果 <code>s[j] &gt;= g[i]</code>，我们可以将这个饼干 <code>j</code> 分配给孩子 <code>i</code> ，这个孩子会得到满足。你的目标是尽可能满足越多数量的孩子，并输出这个最大数值。</p><p><strong>示例 1:</strong></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">输入: g = [1,2,3], s = [1,1]</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>先从左向右遍历一次，如果右边的孩子分数比左边的高，那么右边的孩子比左边的多一颗糖。</p><p>再从右向左遍历一次，如果左边的孩子分数比右边高，那么左边孩子的糖加到比右边孩子多一颗。<img src="https://csnotes.oss-cn-beijing.aliyuncs.com/photos/糖果.gif" alt="" loading="lazy"></p><div class="language-c++ line-numbers-mode" data-highlighter="prismjs" data-ext="c++" data-title="c++"><pre class="language-c++"><code><span class="line">int candy(vector&lt;int&gt; &amp;ratings)</span>
<span class="line">    {</span>
